    ...
    Column{
        ...
        Row{
            ...
            Row{
                ...
                ComboBox {
                    anchors.verticalCenter: module.verticalCenter
                    id: control_m
                    model: 12
                    width:40
                    delegate: ItemDelegate { //控制单个项(每个model，上面是两个)的绘制
                        width: control_m.width
                        contentItem: Text {
                            text: index+1   //即model中的数据
                            color:"black"   //弹窗里文字的颜色
                            font: control_m.font
                            elide: Text.ElideRight
                            verticalAlignment: Text.AlignVCenter
                        }
                        highlighted: control_m.highlightedIndex === index
                        required property int index
                    ...
                    contentItem: Text { //界面上显示出来的文字
                        text: Number(control_m.displayText)+1 //表示ComboBox上显示的文本
                        verticalAlignment: Text.AlignVCenter  //文字位置
                    }
                    popup: Popup {    //弹出项
                        y: control_m.height
                        width: control_m.width
                        height:80
                        //implicitHeight: contentItem.implicitHeight //隐式高度，根据里面的数据有多少确定
                        ...
                        contentItem: ListView {   //界面上显示出来的内容
                            clip: true
                            implicitHeight: contentHeight
                            model: control_m.popup.visible ? control_m.delegateModel : null
                           // currentIndex: control.highlightedIndex
                            //interactive:false //鼠标拖动页面就不能滑动
                            ScrollIndicator.vertical: ScrollIndicator {
            ...
            Row{
                ...
                ComboBox {
                    ...
                    delegate: ItemDelegate { //控制单个项(每个model，上面是两个)的绘制
                        ...
                        highlighted: control_b.highlightedIndex === index
                        required property int index
                    ...
                    contentItem: Text { //界面上显示出来的文字
                        text: Number(control_b.displayText)+1 //表示ComboBox上显示的文本
                        verticalAlignment: Text.AlignVCenter  //文字位置
                    }
                    popup: Popup {    //弹出项
                        y: control_b.height
                        ...
                        contentItem: ListView {   //界面上显示出来的内容
                            clip: true
                            implicitHeight: contentHeight
                            model: control_b.popup.visible ? control_b.delegateModel : null
                           // currentIndex: control.highlightedIndex
                            //interactive:false //鼠标拖动页面就不能滑动
                            ScrollIndicator.vertical: ScrollIndicator {
        ...
        Row{
            ...
            Row{
                ...
                Label{
                    id:crystal
                    text:"Crystal ID Offset:"
                }
                ComboBox {
                    anchors.verticalCenter: crystal.verticalCenter
                    id: control_
                    model: 23
                    width:30
                    delegate: ItemDelegate { //控制单个项(每个model，上面是两个)的绘制
                        ...
                        highlighted: control_.highlightedIndex === index
                        required property int index
                    ...
                    contentItem: Text { //界面上显示出来的文字
                        text: Number(control_.displayText)+1 //表示ComboBox上显示的文本
                        verticalAlignment: Text.AlignVCenter  //文字位置
                    }
                    popup: Popup {    //弹出项
                        y: control_.height
                        ...
                        contentItem: ListView {   //界面上显示出来的内容
                            clip: true
                            implicitHeight: contentHeight
                            model: control_.popup.visible ? control_.delegateModel : null
                           // currentIndex: control.highlightedIndex
                            //interactive:false //鼠标拖动页面就不能滑动
                            ScrollIndicator.vertical: ScrollIndicator {
            ...
            Row{
                ...
                TextField{
                    width:30
                    id:inp_timeWindow
                    anchors.verticalCenter: time_window.verticalCenter
                    selectByMouse: true
                    hoverEnabled:true //是否接受鼠标悬停事件。默认为 false。
                    text:"15"
                    background: Rectangle
                    {
                        //implicitWidth: 40
                        //implicitHeight: 40
                        color: inp_timeWindow.hovered ? "#eeeeee":"white"
                        border.color: inp_timeWindow.hovered ? "#555666" : "white"
                    }
                }
            }
        }
